...
//#define URL_post_esp_data "http://130.204.153.16/Lunnar_Rover/controls.php"
#define URL_post_esp_data "http://130.204.153.16/Lunnar_Rover/receive_frame.php"
#define URL_post_esp_ov7725 "http://130.204.153.16/Lunnar_Rover/receive_frame.php"
//#define URL_post_esp_ov7725 "http://130.204.153.16/Lunnar_Rover/nothing.php"
...
/*	if(strstr(output_buffer, "New measurement created successfully")){
		...
		if(strstr(output_buffer, "doesn't exist")){
			//ESP_LOGI(TAG, "JOB FOR Error: doesn't exist");	// TEST
